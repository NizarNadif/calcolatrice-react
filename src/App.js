...
export function Calcolatrice() {
	...
	return (
		<div className="calcolatrice">
			...
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "sin("))}
				testo={"sin"}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "cos("))}
				testo={"cos"}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "tan("))}
				testo={"tan"}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "%"))}
				testo={"%"}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "log("))}
				testo={"log"}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "√"))}
			...
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "7"))}
				testo={7}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "8"))}
				testo={8}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "9"))}
				testo={9}
			/>
			<Pulsante
			...
			/>
			<Pulsante
				onClick={() => setEspressione(cancellaTutto())}
				testo={"AC"}
				bg_color={["#8BA937", "green"]}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "4"))}
				testo={4}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "5"))}
				testo={5}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "6"))}
				testo={6}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "x"))}
				testo={"X"}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "÷"))}
			...
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "1"))}
				testo={1}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "2"))}
				testo={2}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "3"))}
				testo={3}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "+"))}
			...
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "0"))}
				testo={0}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "."))}
			...
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "π"))}
				testo={"π"}
			/>
			<Pulsante
				onClick={() => setEspressione(inserisci(espressione, "Ans"))}
				testo={"Ans"}
			/>
			<Pulsante
				onClick={() => setRisultato(calcola(espressione))}
				testo={"="}
			/>
		</div>
	);
